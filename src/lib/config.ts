...
export const PROJECT = {
  ...
  version: '1.0.0',
  license: 'GPL-3.0',
  url: 'https://retry-test.minidev.app',
  repository: 'https://github.com/MiniDevPlatform/retry-test',
} as const;
...
export const FEATURES = {
  ...
  // Campaign
  campaign: { enabled: false, levels: [], achievements: [], saveProgress: true, saveKey: 'retry-test_progress' },
